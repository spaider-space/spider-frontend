...
const AgentCarousel: React.FC = () => {
  ...
  return (
    ...
    <div  className="h-screen flex justify-start items-center space-y-10 flex-col">
      <h1 className="text-4xl md:text-5xl  text-center font-bold text-gray-900 mb-4 ">Meet SPAIDER’s AI Agents</h1>
          ...
          {cardsData.map((card, index) => (
            <div key={index} className="w-full flex justify-center  flex-shrink-0">
              <div className="bg-[#F3F0FF] p-6 rounded-lg    shadow-md">
                ...
                <div 
                className="relative rounded-lg overflow-hidden mb-4 h-[500px] w-[700px] "
                >
                  <img
                    src={card.image}
                    alt="AI assistant"
                ...
                <p className="text-xl  text-gray-900 mb-4">{card.description}</p>
