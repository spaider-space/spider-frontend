        ...
        >
          ...
          <div className="space-y-4  basis-[30%]">
            <h3 className="text-lg font-semibold text-gray-900">
              Subscribe to our engineer newsletter
            </h3>
            <p className="text-gray-600">
              Get ahead in the latest in AI for Mechanical design - updates on
              new tools, tips, and best practices. Once a month.
            </p>
            {/* <Button>
              Subscribe
            </Button> */}
            <ShimmerButton>Subscribe</ShimmerButton>
          </div>
